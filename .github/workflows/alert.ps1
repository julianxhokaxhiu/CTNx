...
Invoke-RestMethod -Uri $env:_MAP_CTNx_QHIMM_FF7 -ContentType "application/json" -Method Post -Body $discordPost
Invoke-RestMethod -Uri $env:_MAP_CTNx_QHIMM_FF8 -ContentType "application/json" -Method Post -Body $discordPost
Invoke-RestMethod -Uri $env:_MAP_CTNx_TSUNAMODS_FF7 -ContentType "application/json" -Method Post -Body $discordPost
Invoke-RestMethod -Uri $env:_MAP_CTNx_TSUNAMODS_FF8 -ContentType "application/json" -Method Post -Body $discordPost
